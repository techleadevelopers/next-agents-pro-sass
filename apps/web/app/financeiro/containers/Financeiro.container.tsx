  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-primary/20 via-accent/10 to-primary/20 border border-cyan-400/20 backdrop-blur-md backdrop-saturate-150 p-4 rounded-lg shadow-md animate-gradient-x">
          <MeusPlanosAtuais />
        </div>
        <div className="bg-gradient-to-br from-primary/20 via-accent/10 to-primary/20 border border-cyan-400/20 backdrop-blur-md backdrop-saturate-150 p-4 rounded-lg shadow-md animate-gradient-x">
